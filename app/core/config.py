...
class Settings(BaseSettings):
    ...
    ANTHROPIC_MODEL: str = Field(default="claude-sonnet-4-5", description="claude-sonnet-4-5 or claude-opus-4-5")
    ...
    EMBEDDING_MODEL: str = Field(default="embed-english-v3.0", description="Cohere embedding model for RAG")
    RAG_VECTOR_DIMENSION: int = Field(default=1024, description="Embedding vector dimension (embed-english-v3.0 uses 1024)")
